...
\subsection{Repository and Code Access}

The complete source code, implementation details, and all generated results are available in the GitHub repository:
\begin{center}
\href{https://github.com/Tretorhate/deepl_hw1}{\texttt{https://github.com/Tretorhate/deepl\_hw1}}
\end{center}
